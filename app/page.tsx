...
export default function DashboardPage() {
  ...
  return (
    <main className="relative left-1/2 w-full -translate-x-1/2 space-y-7 text-slate-100 lg:w-[min(calc(100vw-286px-72px),1540px)]">
      <section className="relative min-h-[330px] overflow-hidden rounded-[2rem] border border-white/10 bg-[#111821] shadow-2xl shadow-black/35 ring-1 ring-white/[0.035]">
        <div className="pointer-events-none absolute inset-0 opacity-[0.58]">
          <div
            ...
            style={{
              ...
              filter: "brightness(0.9) contrast(1.12) saturate(0.72)",
            }}
          />
        </div>
        ...
        <div className="relative z-10 min-h-[330px] p-7 lg:p-10">
          ...
          <div className="mt-7 rounded-[1.75rem] border border-white/10 bg-black/30 p-3 shadow-2xl shadow-black/35 backdrop-blur-xl xl:absolute xl:bottom-10 xl:right-10 xl:mt-0 xl:w-[560px]">
        ...
        <div className="grid gap-3 p-5 sm:p-6 md:grid-cols-7">
          {["Mo", "Di", "Mi", "Do", "Fr", "Sa", "So"].map((tag, index) => {
            ...
            return (
              <div
                key={tag}
                className={`min-h-[118px] rounded-3xl border p-4 transition hover:border-sky-300/25 hover:bg-sky-300/8 ${
                  istHeute
      ...
      <details className="group overflow-hidden rounded-[2rem] border border-white/10 bg-[#151c24]/92 shadow-xl shadow-black/25 ring-1 ring-white/[0.025]">
        <summary className="flex cursor-pointer list-none items-center justify-between gap-4 px-5 py-5 transition hover:bg-sky-300/[0.03] sm:px-6">
          ...
          <div className="rounded-2xl border border-white/10 bg-black/28 px-4 py-3 text-sm font-black text-white/70 transition">
...
function HeroMini({
  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-white/[0.055] p-4 text-center transition hover:border-sky-300/25 hover:bg-sky-300/5">
      <div
...
function WorkTimeCard({
  ...
  return (
    <section className="rounded-[1.5rem] border border-white/10 bg-[#111820]/90 p-5 shadow-xl shadow-black/20 ring-1 ring-white/[0.02] transition hover:border-sky-300/25 hover:bg-sky-300/5 hover:shadow-sky-300/10">
