...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-zinc-100">
      ...
      <aside className="fixed left-0 top-0 z-40 hidden h-[100dvh] w-72 flex-col overflow-hidden border-r border-zinc-900 bg-black md:flex">
        ...
        <div className="shrink-0 border-t border-zinc-900 p-4">
          <div className="rounded-3xl border border-zinc-900 bg-zinc-950 p-5">
            ...
            <button
              type="button"
              onClick={logout}
              className="mt-5 flex w-full items-center justify-center gap-2 rounded-2xl bg-orange-500 px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-orange-500/20 transition hover:bg-orange-400"
            >
              <LogOut size={16} />
              Logout
            </button>
