  ...
  return (
    <div className="min-h-screen bg-[#f4f4f5]">
      ...
      <aside className="fixed left-0 top-0 z-40 hidden h-screen w-72 flex-col overflow-hidden border-r border-zinc-900 bg-black md:flex">
        <div className="shrink-0 border-b border-zinc-900 px-6 py-7">
        ...
        <div className="fixed inset-0 z-[999] md:hidden">
          ...
          <aside className="absolute left-0 top-0 flex h-full w-[85%] max-w-xs flex-col overflow-hidden bg-black shadow-2xl">
            <div className="shrink-0 border-b border-zinc-900 px-6 py-6">
              ...
              <span className="mt-2 block text-[10px] font-semibold uppercase tracking-[0.3em] text-zinc-600">
                Swiss ERP
              </span>
            </div>
            ...
            <div className="shrink-0 border-t border-zinc-900 p-4">
              <button
                type="button"
                onClick={logout}
                className="flex w-full items-center justify-center gap-2 rounded-2xl bg-orange-500 px-4 py-3 text-sm font-bold text-white"
              >
                <LogOut size={16} />
                Logout
              </button>
