    ...
    <div className="min-h-screen bg-[#070a0d] text-slate-100">
      ...
      {open && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <aside className="fixed bottom-0 left-0 top-0 h-screen w-[320px] overflow-hidden border-r border-slate-300/60 bg-[#edf2f6]">
            <Sidebar
              pathname={pathname}
              logout={logout}
              userName={userName}
      ...
      <aside className="fixed bottom-0 left-0 top-0 z-30 hidden h-screen w-[320px] overflow-hidden border-r border-slate-300/50 bg-[#edf2f6] shadow-2xl shadow-black/50 lg:block">
        <Sidebar
          pathname={pathname}
          logout={logout}
          userName={userName}
