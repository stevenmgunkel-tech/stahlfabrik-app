    ...
    <div className="min-h-screen bg-[#070a0d] text-slate-100">
      ...
      {open && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <aside className="fixed inset-y-0 left-0 h-screen min-h-screen w-[320px] overflow-hidden border-r border-slate-300/60 bg-[#edf2f6]">
            <Sidebar
              pathname={pathname}
              logout={logout}
              userName={userName}
      ...
      <aside className="fixed inset-y-0 left-0 z-30 hidden h-screen min-h-screen w-[320px] overflow-hidden border-r border-slate-300/50 bg-[#edf2f6] shadow-2xl shadow-black/50 lg:block">
        <Sidebar
          pathname={pathname}
          logout={logout}
          userName={userName}
...
function Sidebar({
  ...
  return (
    <div className="flex h-screen min-h-screen w-full flex-col bg-gradient-to-b from-[#f8fafc] via-[#edf2f6] to-[#dfe6ec] px-4 py-5 text-slate-950">
